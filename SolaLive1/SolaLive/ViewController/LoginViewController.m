...
- (void)viewDidLoad {
    ...
    if (![[AccountLocalData sharedInstance] address]) {
        [[AccountLocalData sharedInstance] setAddress:@"http://ibo100.sola.cn"];
    }
...
//    _hud.dimBackground = YES;
    ...
    [self webServiceConnectionWithUrl:url userName:_nameTF.text pwd:_pswTF.text nameSpace:@"http://tempuri.org/" method:@"CheckLoginUser"];
